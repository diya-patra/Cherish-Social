    ...
    <>
      {
        loading? <h1>Loading...</h1> :
          <div className="flex justify-center bg-gray-50 min-h-screen py-10"/*"flex justify-center"*/>
            <div className="flex flex-col justify-center items-center md:flex-row shadow-lg rounded-2xl bg-white overflow-hidden max-w-7xl w-[90%] md:w-[60%]"/*"flex flex-col justify-center items-center md:flex-row shadow-md rounded-xl max-w-7xl w-[90%] md:w-[50%] md:mt-[140px]"*/>
              <div className="w-full md:w-2/3 px-6 py-8"/*"w-full md:w-3/4"*/>
                <div className="flex flex-col text-center mb-6"/*"text-xl cursor-pointer flex flex-col justify-center items-center mt-5 md:mt-0 py-4"*/>
          ...
          {/* <div className="text-white text-base font-semibold text-center my-10 space-y-2 m-2"> */}
                <h1 className="text-4xl font-bold mb-3"/*"text-5xl"*/>Don't Have Account?</h1>
            <p className="mb-6">Register to Social Media</p>
            <Link
              to="/register"
