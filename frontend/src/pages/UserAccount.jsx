                                        ...
                                        <div className="flex flex-col gap-2 text-center md:text-left"/*"flex flex-col gap-2"*/>
...

                                            {
                                                user._id === loggedInUser._id ? "" :
                                                    <button onClick={followHandler} className={`mt-3 px-6 py-2 rounded-lg shadow font-semibold text-white transition ${followed ? "bg-red-500 hover:bg-red-600" : "bg-blue-500 hover:bg-blue-600"
                                                        }`/*`py-2 px-5 text-white rounded-md ${followed ? "bg-red-500" : "bg-blue-400"}`*/}>{followed ? "UnFollow" : "Follow"}</button>
                                            }
                                        </div>
                                    </div>
